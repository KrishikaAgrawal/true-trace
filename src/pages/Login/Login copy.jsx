  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-900 overflow-hidden">
      ...
      <img
        src={heroImage}
        alt="Hero"
        className="w-full h-[200px] lg:h-[500px] object-cover fixed top-0"
      />

      {/* Glassmorphism Card */}
      <form
        onSubmit={handleSubmit}
        className="backdrop-blur-lg bg-emerald-900/10 border border-white/25 shadow-xl rounded-2xl p-6 w-11/12 max-w-lg mt-48 lg:mt-0"
      >
